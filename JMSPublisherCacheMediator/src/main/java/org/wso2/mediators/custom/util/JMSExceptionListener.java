...
public class JMSExceptionListener implements ExceptionListener {
    ...
    public void onException(JMSException e) {
        ...
        synchronized (publisherContextKey.intern()) {
            log.warn("Cache will be cleared due to JMSException for destination : " + publisherContextKey, e);
            ...
            JMSPublisherContext publisherContext = JMSPublisherCache.getJMSPublisherCache().getAndRemove(publisherContextKey);

            publisherContext.close();

            log.warn("Cache has been cleared to a JMSException for destination : " + publisherContextKey, e);
        }
    }
}
