...
public class QueueReceiver {
    ...
    public static void start(String _queueName) throws NamingException, JMSException {
    ...
    public void receiveMessages() throws NamingException, JMSException {
        ...
        MessageListener myMsgListener = new MyMessageListener(queueConnection,queueSession,queueReceiver);

        queueReceiver.setMessageListener(myMsgListener);
